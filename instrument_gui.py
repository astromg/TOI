...
class InstrumentGui(QWidget, BaseAsyncWidget, metaclass=MetaAsyncWidgetQtWidget):
      ...
      def __init__(self, parent, loop: QEventLoop = None, client_api=None):
          ...
          self.resize(self.parent.instrument_geometry[2], self.parent.instrument_geometry[3])
          self.move(self.parent.instrument_geometry[0], self.parent.instrument_geometry[1])
          self.updateUI()
          self.show()
          self.raise_()
